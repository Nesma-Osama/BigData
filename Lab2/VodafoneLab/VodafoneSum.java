...
public class VodafoneSum {
    ...
    public static class SumMapper extends Mapper<LongWritable, Text, Text, IntWritable> {
        ...
        public void map(LongWritable key, Text value, Context context)
            ...
            if (parts.length == 2) {
                customerId.set(parts[0].trim());
                amount.set(Integer.parseInt(parts[1].trim()));
    ...
    public static void main(String[] args) throws Exception {
        ...
        Job job = Job.getInstance(conf, "Vodafone Prepaid Card Sum");
        job.setJarByClass(VodafoneSum.class);
